class CommentsController < ApplicationController
  before_action :set_startup, only: [:create, :edit, :update, :destroy]
  before_action :login_check, only: [:create, :edit, :destroy]
  def create
  ...
  def login_check
    redirect_to new_user_session_path, notice:('you are not login, please login or create new accompt') unless user_signed_in?
  end
end
